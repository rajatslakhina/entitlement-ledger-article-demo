...
/// 1 October. A month later she sees the cheaper in-app price, subscribes again
/// through the payment processor, and is now paying twice — and neither Apple nor
/// the processor can see the other side of it. On day 44 the processor refunds her.
/// An app that treats its PSP webhook as the source of truth locks out a customer
/// who is still paying Apple €49.99 a year.
///
    ...
    private func makeLedger() -> EntitlementLedger {
        var events: [ReceiptEvent] = [
            ...
            ReceiptEvent(
                ...
                expiresAt: Self.launch.addingTimeInterval(61 * Self.day),
